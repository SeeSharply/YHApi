    ...
    public class MyConfig : Entities
    {
        ...
        public static IDbConnection DefaultConnection
        {
            get
            {
                ...
                //数据库类型
                string action = ConfigurationManager.AppSettings["dbtype"];
                switch (action)
                {
                    //case "oracle":
                    ...
                    case "mysql":
                        defaultConn = new System.Data.SqlClient.SqlConnection();
                        DefaultConnectionString = ConfigurationManager.ConnectionStrings["MysqlConnectionString"].ConnectionString;
                        break;
                    default:
                        break;
                }
